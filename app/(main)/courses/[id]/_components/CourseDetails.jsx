...
import CourseCarriculum from './CourseCarriculum';
  ...
  return (
    <section className='py-8 md:py-12 lg:py-24'>
      <div className='container'>
        <span className='bg-success px-4 py-0.5 rounded-full text-xs font-medium bg-green-400 text-white inline-block'>
        ...
        <div className='my-6'>
          <Tabs
            ...
            <TabsContent value='curriculum'>
              <CourseCarriculum course={course} />
            </TabsContent>
